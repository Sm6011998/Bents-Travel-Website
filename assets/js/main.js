(function ($) {
  ...
  // ========================== add active class to navbar menu current page Js Start =====================
   ...
   // **************************** Populer Destination custom js written ****************************

   document.querySelectorAll('.col-custom').forEach(function(col) {
    col.addEventListener('click', function() {
        // Remove active from all
        document.querySelectorAll('.col-custom').forEach(function(c) {
    ...
    // Set initial bg for already-active item on page load
    if (col.classList.contains('active')) {
        var bg = col.getAttribute('data-bg');
        if (bg) {
            bg = bg.replace(/\\/g, '/');
  ...
  // ========================== Add Attribute For Bg Image Js Start ====================
    $(".background-img").css('background', function () {
      var imagePath = ($(this).data("background-image") || '').replace(/\\/g, '/');
      var bg = ('url(' + imagePath + ')');
      return bg;
    });
